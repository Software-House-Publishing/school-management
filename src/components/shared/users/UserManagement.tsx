...
// Re-export ColumnDef for consumers like SchoolTeacherList
...
export function UserManagement({
  ...
  const defaultColumns: ColumnDef<User>[] = [
    {
      header: 'User',
      accessorKey: 'firstName', // Sort by first name, cell renders full layout
      sortable: true,
      cell: (user) => (
    ...
    },
    {
      ...
      cell: (user) => user.isActive ? (
        <div className="flex items-center justify-center">
          <div className="h-2 w-2 rounded-full bg-green-500 mr-2 shadow-[0_0_8px_rgba(34,197,94,0.4)]"></div>
