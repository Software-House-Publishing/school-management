...
export const jobOpenings: JobOpening[] = [
  ...
  { 
    ...
    location: 'London, UK', 
    type: 'Full-time',
    description: 'We are seeking a Customer Success Manager to ensure our school partners achieve their goals with AcademiaOS. You will be the trusted advisor for our customers.',
    requirements: [
...
export const pressItems: PressItem[] = [
  { 
    ...
    date: 'Oct 24, 2023', 
    title: 'AcademiaOS Raises Series B Funding to Expand Global Reach', 
    source: 'TechCrunch',
    content: 'AcademiaOS, the leading school management platform, today announced it has raised Series B funding led by top-tier venture capital firms. This investment will accelerate our mission to transform education globally.'
  },
  { 
    id: '2',
  ...
  { 
    ...
    date: 'Aug 01, 2023', 
    title: 'AcademiaOS Named Best School Management System of 2023', 
    source: 'Education Week',
    content: 'AcademiaOS has been recognized as the Best School Management System of 2023 by Education Week. This award highlights our commitment to excellence and our positive impact on schools around the world.'
  },
];
