    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage administrators for each school</p>
        </div>
      ...
      <Card>
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900">No school admins yet</h3>
          <p className="text-sm text-gray-500 mt-1">Add administrators to manage schools</p>
        </div>
      </Card>
    </div>
  );
